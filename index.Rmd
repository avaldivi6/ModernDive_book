...
```{r echo=FALSE}
# Install and load pdftools package
#install.packages("pdftools")
suppressPackageStartupMessages(library(pdftools))

# URL of the PDF
pdf_url <- "https://ismaytemp.github.io/ModernDive_book/ModernDive.pdf"
# Download PDF file to a temporary file
temp_pdf <- tempfile(fileext = ".pdf")
download.file(pdf_url, temp_pdf, mode = "wb")

# Get information about the PDF, including the number of pages
pdf_info <- pdf_info(temp_pdf)

# Print the number of pages
print(paste("The PDF version of this book has", pdf_info$pages, "pages."))
...
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png" /></a><br />This work by [Chester Ismay](https://chester.rbind.io/), [Albert Y. Kim](https://rudeboybert.rbind.io/), and [Arturo Valdivia](https://stat.indiana.edu/about/core-faculty/core-faculty/valdivia-arturo.html) is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>.
