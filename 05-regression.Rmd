...
UN_data_ch5 <- un_member_states_2024 |>
  select(iso, fert_rate, life_expectancy_2022, obes_rate) |> 
  na.omit()

UN_data_ch5 <- un_member_states_2024 |>
  select(iso, life_expectancy_2022, fertility_rate_2022, obes_rate)|>
  na.omit()|>
  rename(life_exp = life_expectancy_2022, fert_rate = fertility_rate_2022, 
         obesity_rate_2016 = obes_rate)|>
  na.omit()
```
...
gapminder2022 <- un_member_states_2024 |>
  select(country, life_exp, continent, gdp_per_capita) |> 
  na.omit()
```
...
```{r}
ggplot(data = un_member_states_2024, aes(x = hdi_2022, y = life_exp)) +
  geom_point() +
  labs(x = "Human Development Index (HDI)", y = "Life Expectancy")
```

```{r, eval=FALSE}
ggplot(data = un_member_states_2024, aes(x = hdi_2022, y = fert_rate)) +
  geom_point() +
...
un_member_states_2024 |> 
  get_correlation(life_exp ~ hdi_2022, na.rm = TRUE)
```

```{r}
un_member_states_2024 |> 
  get_correlation(fert_rate ~ hdi_2022, na.rm = TRUE)
```
