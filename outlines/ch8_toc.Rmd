...
### Using the normal curve for the sampling distribution of the sample mean

## Constructing confidence intervals using the normal curve {#ci-theory-process}

## Case study: yawning contagious or other case study {#case-study-two-prop-ci}


## Revisiting the Activities for Estimation

Revisiting the red balls activity {#estimation-bowl-activities}

Brief comments about using activities as a tool for estimation

### Red balls: Sample proportions as estimates of the population proportion?

#### One sample proportion

Use the first sample proportion obtained in ch7 and show how far is this from the population proportion in terms of the SE of $\bar X$

#### 33 sample proportions

Use the 33 sample proportions obtained earlier and show how close they are for the population proportion in terms of SE of $\bar X$

#### 1000 sample proportions

- Revisit the sampling distribution of the sample proportion
- Show how the sampling variation is present
- Highlight the percentage of sample proportions that are within 2 SE from the population proportion

#### Constructing intervals as estimate {#estimation-proportion}

- Show how can we use the sampling distribution as a tool to construct intervals
- Show how about 95% of the 1000 sample proportions are within 2 SE from the true population proportion
- Construct an interval based on any one sample and show how this interval contains the true population proportion
- Show the image where 95% of the intervals contain the population proportion

### Case Study: COVID (return to normalcy)

Introduce the case study, focus on the sample proportion and SE obtained and use them to construct a 95% confidence interval

### Chocolate-covered almonds: Sample means as estimates of the population mean?

- Use again one, 33, and 1000 sample means. Use the latter to reiterate the sampling distribution of the sample mean.
- Show the dispersion and highlight the percentage of sample means that are within 2 SE from the population mean

#### Constructing confidence intervals

- Construct an interval based on any one sample and show how this interval contains the true population proportion
- Show how about 95% of the confidence intervals obtained earlier include the population proportion and 5% don't

### When we only have one sample of almonds: Bootstrap sampling

Introduce bootstrap sampling in the context of the activity only, deeper explanation come later

#### Resampling one bootstrap samplece

#### Resampling 33 bootstrap samples

#### Resampling 1000 bootstrap samples

- Construct the confidence interval using bootstrap samples
- Compare with the confidence interval for the sample obtained earlier
...
### The sampling distribution approach
### The bootstrap sampling approach
...
### Bootstrap sampling: theoretical framework
...
#### Best practices when using bootstrap samples for confidence intervals
