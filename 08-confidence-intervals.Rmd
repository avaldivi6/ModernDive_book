...
Based on the characteristics of the sampling distribution, stated above, if we have access to a large number of random samples, we know that the average of all those sample means will be a really good estimate of the expected value, which happen to be precisely the population mean weight.
